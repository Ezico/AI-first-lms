...
export default function LearningInterface({
  ...
  console.log("Current Lesson:", courseModules);
  ...
  const goToPreviousLesson = () => {
    if (currentLessonIndex > 0) {
      ...
      const prevLesson =
        courseModules[currentModuleIndex].lessons[currentLessonIndex - 1];
  ...
  const markAsComplete = async () => {
    ...
    try {
      ...
      updatedModules[currentModuleIndex].lessons[currentLessonIndex].completed =
        true;
      updatedModules[currentModuleIndex].lessons[currentLessonIndex].progress =
        100;
  ...
  const handleQuizSubmit = async () => {
    ...
    const questionIds = Array.from(questions).map((q) =>
          ...
          <div className="flex-1 flex justify-center">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm font-medium text-gray-700">
                ...
                {courseModules[currentModuleIndex]?.lessons.length || 0}
              </span>
              <button
                className="text-gray-500 hover:text-gray-700 disabled:opacity-50"
                ...
                disabled={
                  currentModuleIndex === courseModules.length - 1 &&
                  currentLessonIndex ===
                    (courseModules[currentModuleIndex]?.lessons.length || 0) - 1
                }
              >
                ...
                {currentLesson.type === "video" && (
                  <div className="mb-6">
                    <div className="relative aspect-video bg-black rounded-lg overflow-hidden">
                      <CustomVideoPlayer src={currentLesson.content} />
                    </div>
                  </div>
                )}
                      ...
                      <div className="prose max-w-none">
                        {currentLesson.content ? (
                          ...
                          <>
                            ...
                            <p>
                              An effective AI roadmap is essential for
                              organizations looking to implement AI solutions
                              strategically. This document outlines the key
                              components of a comprehensive AI roadmap and
                            ...
                            <ol>
                              <li>
                                ...
                                <p>
                                  Begin by assessing your organization's current
                                  AI capabilities, including existing
                                  technologies, data infrastructure, and team
                                  skills.
                                </p>
                              </li>
                              <li>
                                ...
                                <p>
                                  Define clear objectives for your AI
                                  initiatives that align with your overall
                                  business strategy.
                                </p>
                              </li>
                              <li>
                                ...
                                <p>
                                  Identify and prioritize AI use cases based on
                                  business value, feasibility, and strategic
                                  alignment.
                                </p>
                              </li>
                              <li>
                              ...
                              <li>
                                ...
                                <p>
                                  ...
                                  technology, talent, and budget.
                                </p>
                              </li>
                            </ol>
                            <p>
                              Download the full document and worksheets to start
                              building your AI roadmap today.
                            </p>
                          </>
                        )}
                      </div>
                          ...
                          <div className="space-y-6">
                            ...
                            >
                              <h3 className="font-medium text-gray-900 mb-3">
                                1. Which of the following is NOT a key component
                                of an AI roadmap?
                              </h3>
                            ...
                            >
                              <h3 className="font-medium text-gray-900 mb-3">
                                2. When prioritizing AI use cases, which factor
                            ...
                            >
                              <h3 className="font-medium text-gray-900 mb-3">
                                3. What is the recommended first step in
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mb-1">
                          Download this template to start building your own AI
                          roadmap.
                        </p>
                        <Button
                          variant="link"
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mb-1">
                          Join the discussion on AI roadmap development with
                          your peers.
                        </p>
                        <Button
                          variant="link"
